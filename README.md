# Vue3 CRUD - LocalStorage - Bootstrap (Ejemplo Práctico)
Tutorial práctico para el uso de Vue.js 3, con LocalStorage API como almacenamiento y el framework CSS Bootstrap, para realizar un CRUD.
